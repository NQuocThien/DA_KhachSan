...
<div class="main_infouser row" >
    <h3 class="col l-12" >Thông tin cá nhân</h3>
    ...
    <button id="btn_chonImg" onclick="document.getElementById('myFileInput').click()">Chọn hình ảnh</button>
