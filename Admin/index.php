...
<head>
    ...
    <?php
        if( $page=='ql_chuoikhachsan') echo "<title>Trang Chuỗi Khách Sạn</title>";
        elseif ( $page=='ql_khachsan') echo "<title>Trang Quản Lý Khách Sạn</title>";
        elseif ( $page=='quanlydatphong') echo "<title>Trang Quản Lý Đặt Phòng</title>";
        elseif ( $page=='quanlyroom') echo "<title>Trang Quản Lý Phòng</title>";
        elseif ( $page=='quanlyloaiphong') echo "<title>Trang Quản Lý Loại Phòng</title>";
        elseif ( $page=='ql_baiviet') echo "<title>Trang Quản Lý Bài Viết</title>";
        elseif ( $page=='ql_chude') echo "<title>Trang Quản Lý Chủ Đề</title>";
        elseif ( $page=='ql_khachhang') echo "<title>Trang Quản Lý Khách Hàng</title>";
        elseif ( $page=='user') echo "<title>Trang Người Dùng</title>";
    ?>
