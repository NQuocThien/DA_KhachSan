...
<div class="main_insert-content">
    <h3>Sửa bài viết</h3>
    <form enctype="multipart/form-data"  action="index.php?do=sua_baiviet-submit" method="post" id="form_insert-content">
        <input type="hidden" value="<?php echo $MaBV ?>" name="MaBV">
        <div class="row ">
